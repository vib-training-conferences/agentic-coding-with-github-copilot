...
- Ask Copilot to create a new script named `main.py` that imports all the functions from the other scripts, creates a small synthetic reference sequence and some synthetic reads, and runs the entire pipeline end-to-end (parsing, alignment, variant calling, filtering, and writing VCF).

***

### 6. Agent - Code Translation

This pipeline is currently written in Python, but imagine you want to share it with a colleague who prefers R or C++. You can ask Copilot to translate the entire pipeline to another programming language.

- Ask Copilot to translate the entire pipeline to R or C++. See how it maps language-specific features (like generators vs lists).
